####################################################################################################
## Coded at Smart India hackathon 2018                                                               ##
## Problem Statement : Centrailised Wireless Home Appliance Control System                        ##    
## Team Name :Team_Orca                                                         ## 
## Code is contructed for the interferance of RaspberryPi and ArduinoUno(Slave-Master)            ##
## written in python with using ArduinoApi, Google Firebase is used to store and compute data.    ##
####################################################################################################
